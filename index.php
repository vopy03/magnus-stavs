...
<head>
	...
	<meta name="description" content="<?php echo strip_tags($contactsinfo['about_us']) ?>">
  	<meta name="keywords" content="stavební firma, stavebnictví v ČR, konstrukce">
...
<body>
	...
	<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
		  <div class="offcanvas-header">
		    ...
		    <button type="button" id="closeOffCanvasBtn" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
		  </div>
		  <div class="offcanvas-body">
		  	<div class="burger-main-links">

				<a href="#link0main" onclick="closeOffcanvas()">Hlavní</a>
				<a href="#link1about" onclick="closeOffcanvas()" >O nás</a>
				<a href="#link2services" onclick="closeOffcanvas()">Služby</a>
				<a href="#link3contacts" onclick="closeOffcanvas()">Kontakty</a>
				<a href="#link4works" onclick="closeOffcanvas()">Naše díla</a>
				<a href="#link5reviews" onclick="closeOffcanvas()">Recenze</a>
			</div>
			<script type="text/javascript">
				function closeOffcanvas() {
					setTimeout(() => document.querySelector('#closeOffCanvasBtn').click(), 500)
				}
			</script>
		  </div>
	</div>
	...
	<content class="main-content">
		...
		<div class="container-text" >
			<div class="text">
				<h3><i class="iAnchor" id="link1about" ></i><span class="material-icons">groups_3</span>O nás</h3>
				<p><?php echo $contactsinfo['about_us'] ?></p>
		...
		<div class="container-text" >
			...
			<div class="text">
				<h3><i class="iAnchor" id="link2services" ></i><span class="material-icons-outlined" style="color:black">construction</span>Služby</h3>
			</div>
		...
		<div class="container-text" >
			<div class="text">
				<h3><i class="iAnchor" id="link3contacts" ></i><span class="material-icons">call</span>Kontakty</h3>
		...
		<div class="container-text" >
			<div class="text">
				<h3><span class="material-icons">apartment</span>Naše díla</h3>
			</div>
		...
		<div class="container-text" >
			<div class="text">
				<h3><i class="iAnchor" id="link5reviews"></i><span class="material-icons">reviews</span>Recenze</h3>
			</div>
